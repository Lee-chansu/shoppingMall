        ...
        <form className="findUserIdBox">
          <div className="inputBox">
            <div className="inputUsername">
              <input type="text" placeholder=" 사용자 이름 입력" className="textWrapper2" onChange={valueChange} name="userName"></input>
            </div>
            <div className="inputUserPhoneNumber">
              <input type="email" placeholder=" 사용자 이메일 입력" className="textWrapper2" onChange={valueChange} name="email"></input>
            </div>
            {
