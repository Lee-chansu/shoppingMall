        ...
        <div className="joinBox">
          ...
          <div className="overlapGroup">
            <div className="allCheck">
              <input type="checkbox" className="rectangle" id="all" name="allCheck" onChange={CheckListClick} checked={checkList.allCheck}/>
              <label htmlFor="all" className="textWrapper">전체동의</label>
              <div className="vector" />
            </div>
            <div className="check">
              <input type="checkbox" className="rectangle" id="firstCheck" name="firstCheck" onChange={CheckListClick} checked={checkList.firstCheck}/>
              <label htmlFor="firstCheck" className="div">개인정보 수집 동의 및 이용안내 <div className="subtxt1">(필수)</div></label>
              <textarea disabled className="text1" defaultValue="개인정보보호법에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
          ...
          <div className="check2">
            <input type="checkbox" className="rectangle" id="secondCheck" name="secondCheck" onChange={CheckListClick} checked={checkList.secondCheck}/>
            <label htmlFor="secondCheck" className="div">마케팅 수신동의 <div className="subtxt2">(선택)</div></label>
            <textarea disabled className="text2" defaultValue="마케팅 정보 수신 동의
